    ...
    <div class="text-center">
        <!-- Illustration -->
        <div class="mb-6">
            <i class="fa-solid fa-gear text-amber-600 text-6xl animate-pulse"></i>
        </div>

        <!-- Main Content -->
        <h1 class="font-extrabold text-8xl text-amber-700 tracking-tight">503</h1>
        <h2 class="text-2xl md:text-3xl font-semibold text-gray-800 mt-3">Service Temporarily Unavailable</h2>
