            ...
            <div class="flex items-center justify-center min-h-screen p-4">
                <div class="w-full max-w-md">
                    ...
                    <div class="bg-white rounded-xl shadow-lg border border-gray-100 p-8">
                        ...
                        <form id="loginForm">
                            ...
                            <div class="mb-2">
                                ...
                                <div class="relative">
                                    ...
                                    <input type="password" id="password" name="password" required
                                        class="block w-full pl-10 pr-10 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:outline-none focus:ring-amber-500 focus:border-amber-500 transition-colors"
                                        placeholder="••••••••">
                            ...
                            <div class="grid grid-cols-2 gap-4 mb-6">
                                <button type="button"
                                    class="flex items-center justify-center gap-2 py-3 px-4 border border-gray-300 rounded-lg hover:bg-gray-50 transition-colors">
                    ...
                    <p class="text-center text-gray-500 text-xs mt-8">
                        ...
                        <a href="/terms" class="text-amber-600 hover:text-amber-700">Terms</a>
                        and
                        <a href="/privacy" class="text-amber-600 hover:text-amber-700">Privacy Policy</a>
                    </p>
                </div>
            </div>
        </div>
