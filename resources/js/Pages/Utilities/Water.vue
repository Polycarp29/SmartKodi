    ...
    <DashboardLayout>
        <div class="space-y-6 pb-12">
            ...
            <div class="grid lg:grid-cols-3 gap-6">
                <!-- Summary Card -->
                <MediumCard class="flex flex-col justify-between border-l-4 border-l-blue-500">
                    <div>
                        <p class="text-[10px] font-bold text-gray-400 uppercase tracking-widest mb-1">Current Usage</p>
                        <div class="text-4xl font-black text-gray-800">{{ stats.currentConsumption }} <span class="text-lg text-gray-400 font-bold">m³</span></div>
                ...
                <div class="overflow-x-auto">
                    <table class="w-full text-left">
                        ...
                        <tbody class="divide-y divide-gray-50">
                            <tr v-for="reading in readings" :key="reading.id" class="group hover:bg-blue-50/30 transition-all duration-300">
                                <td class="py-4 pl-4">
                                ...
                                <td class="py-4 pr-4 text-right">
                                    <button class="w-8 h-8 rounded-lg text-gray-400 hover:text-blue-600 hover:bg-blue-50 transition-all flex items-center justify-center">
